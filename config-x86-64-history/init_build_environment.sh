...
function update_apt_source() {
	...
	if [ -n "$CHN_NET" ]; then
		...
		if [ "$VERSION_CODENAME" == "$UBUNTU_CODENAME" ]; then
			...
			cat <<-EOF > "/etc/apt/sources.list"
				deb https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian/ $VERSION_CODENAME main contrib non-free${APT_COMP:+ $APT_COMP}
				deb-src https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian/ $VERSION_CODENAME main contrib non-free${APT_COMP:+ $APT_COMP}

				deb https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian-security ${DISTRO_SECUTIRY_PATH:-$VERSION_CODENAME-security} main contrib non-free${APT_COMP:+ $APT_COMP}
				deb-src https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian-security ${DISTRO_SECUTIRY_PATH:-$VERSION_CODENAME-security} main contrib non-free${APT_COMP:+ $APT_COMP}

				deb https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian/ $VERSION_CODENAME-updates main contrib non-free${APT_COMP:+ $APT_COMP}
				deb-src https://mirrors.tuna.tsinghua.edu.cn/${DISTRO_PREFIX}debian/ $VERSION_CODENAME-updates main contrib non-free${APT_COMP:+ $APT_COMP}

				deb https://mirrors.tuna.tsinghua.edu.cn/${BPO_DISTRO_PREFIX:-$DISTRO_PREFIX}debian/ $VERSION_CODENAME-backports main contrib non-free${APT_COMP:+ $APT_COMP}
				deb-src https://mirrors.nju.edu.cn/${BPO_DISTRO_PREFIX:-$DISTRO_PREFIX}debian/ $VERSION_CODENAME-backports main contrib non-free${APT_COMP:+ $APT_COMP}
			EOF
		fi
	else
